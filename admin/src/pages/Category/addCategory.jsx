      ...
      <form action="" className="form p-8 py-3 ">
        <div className="scroll max-h-[75vh] overflow-y-scroll pr-4 pt-4">
          <div className="col">
            ...
            <input
              type="text"
              className="w-[28%] h-[35px] border border-[rgba(0,0,0,0.2)] focus:outline-none focus:border-[rgba(0,0,0,0.4)] rounded-sm p-3 text-sm"
            />
          </div>
          <br />
          <h3 className="text-[14px] font-[500] mb-3">Categpry Image</h3>
